...
var db = require('monk')('localhost/mmn-christa');
...
router.get('/', function (req, res) {
    ...
    notesCollection.find({}, function(e,docs){
        if(!e){
            var temp = {
                status: 'success',
...
router.post('/insert', function (req, res) {
    ...
    if (req.body && req.body.notes) {
        ...
        notesCollection.insert(req.body.notes,function(e,docs){
            if(!e){
                var temp = {
                    status: "success",
                    message: "inserting some notes",
                    inserted: [req.body.notes]
                }
                res.json(temp);
            }else{
                next(e);
